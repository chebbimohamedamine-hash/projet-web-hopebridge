...
<head>
    ...
    <title>HopeBridge | Réinsertion Professionnelle</title>
...
<body>
    ...
    <main class="gallery-container">
        <div class="gallery-header">
            <h1><i class="fas fa-graduation-cap"></i> Réinsertion Professionnelle</h1>
            <p>Nous croyons en la capacité de chaque individu à se reconstruire. Formations, accompagnement et soutien psychologique pour retrouver un emploi stable et une vie digne.</p>
        </div>

        <div class="gallery-grid">
            <div class="gallery-item">
                <img src="assets/reinsertion1.jpg" alt="Formation professionnelle" class="gallery-img">
            </div>
            <div class="gallery-item">
                <img src="assets/reinsertion2.jpg" alt="Réinsertion professionnelle" class="gallery-img">
            </div>
            <div class="gallery-item">
                <img src="assets/reinsertion3.webp" alt="Accompagnement" class="gallery-img">
            </div>
        </div>
