...
<head>
    ...
    <title>HopeBridge | Aide Alimentaire</title>
...
<body>
    ...
    <main class="gallery-container">
        <div class="gallery-header">
            ...
            <p>Notre mission est de s'assurer que personne ne souffre de la faim. Découvrez nos actions de distribution de repas et notre engagement envers les plus démunis.</p>
        </div>

        <div class="gallery-grid">
            <div class="gallery-item">
                <img src="assets/aide1.png?v=1" alt="Distribution de nourriture" class="gallery-img">
            </div>
            <div class="gallery-item">
                <img src="assets/aide2.jpg" alt="Bénévoles" class="gallery-img">
            </div>
            <div class="gallery-item">
                <img src="assets/aide3.jpg" alt="Centre communautaire" class="gallery-img">
            </div>
        </div>
